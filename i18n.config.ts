export default defineI18nConfig(() => ({
    ...
    messages: {
        pl: {
            ...
            techDescription: 'Uwielbiam prace zespołową, wymianę spostrzerzeń oraz rozwiązywanie skomplikowanych problemów. W procesie wytwarzania kodu wykorzystuję najlepsze praktyki w celu zapewniania stabilność, skalowalności oraz łatwego dostępu do funkcjonalności aplikacji',
            ...
            pragmaticAd: 'Rozwój oraz wsparcie w utrzymaniu skryptu mirzącego działaność użytkownika. Wsparcie techniczne przy integracjach.',
